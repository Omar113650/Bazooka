...
router.post("/add-offers", VerifyTokenAdmin,upload.single("Image"), createOffers);

router.put("/update-offer/:id", VerifyTokenAdmin,ValidatedID,upload.single("Image"), updateOffers);

router.delete("/delete-offer/:id",VerifyTokenAdmin ,ValidatedID,deleteProduct);
